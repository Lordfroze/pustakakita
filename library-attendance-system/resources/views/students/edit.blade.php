                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('students.update', $student) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="nis" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('nis') border-red-500 @enderror" type="text" name="nis" value="{{ old('nis', $student->nis) }}" required autofocus>
                            @error('nis')
                        ...
                        <div class="mb-4">
                            ...
                            <input id="nama" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('nama') border-red-500 @enderror" type="text" name="nama" value="{{ old('nama', $student->nama) }}" required>
                            @error('nama')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="kelas" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('kelas') border-red-500 @enderror" type="text" name="kelas" value="{{ old('kelas', $student->kelas) }}" required>
                            @error('kelas')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="jurusan" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('jurusan') border-red-500 @enderror" type="text" name="jurusan" value="{{ old('jurusan', $student->jurusan) }}">
                            @error('jurusan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="alamat" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('alamat') border-red-500 @enderror" name="alamat" rows="3">{{ old('alamat', $student->alamat) }}</textarea>
                            @error('alamat')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="no_telp" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('no_telp') border-red-500 @enderror" type="text" name="no_telp" value="{{ old('no_telp', $student->no_telp) }}">
                            @error('no_telp')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
