                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $todayStats['total'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Aktif Sekarang</p>
                                <p class="text-2xl font-semibold text-gray-900">{{ $todayStats['aktif'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $todayStats['selesai'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold text-gray-900">Pengunjung Aktif</h3>
                        <button onclick="location.reload()" class="inline-flex items-center px-3 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 focus:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($activeVisitors as $attendance)
                                        @php
                                            $waktuMasuk = \Carbon\Carbon::parse($attendance->tanggal->format('Y-m-d') . ' ' . $attendance->waktu_masuk);
                                            $durasi = $waktuMasuk->diffForHumans(null, true);
                                        @endphp
                                        <tr>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">Tidak ada pengunjung aktif</h3>
                            <p class="mt-1 text-sm text-gray-500">Belum ada pengunjung yang sedang berada di perpustakaan.</p>
                        </div>
                    @endif
                </div>
            </div>
